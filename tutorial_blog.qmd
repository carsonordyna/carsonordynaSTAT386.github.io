...
2. [**The Mathematical Model**](#the-mathematical-model)
3. [**A Brief Demo**](#a-brief-demo)
...
![Hazard Function Graph](harzard_graph.png){ width=50% height=40% }
